...
def test_king_attacked_by_pawn_is_check():
    ...
    assert Game(fen).rules.is_check
...
def test_king_attacked_by_queen_is_check():
    ...
    assert Game(diagonal_fen).rules.is_check
    assert Game(straight_fen).rules.is_check
...
def test_escape_by_capturing_attacker():
    ...
    assert game.rules.is_legal(rook_captures_rook)
...
def test_escape_by_king_captures_attacker():
    ...
    assert game.rules.is_check
    assert game.rules.is_legal(king_captures_rook)
...
def test_escape_by_moving_king_to_safe_square():
    ...
    assert game.rules.is_check
    assert game.rules.is_legal(king_moves_in_front_of_pawn)
...
def test_escape_by_blocking_line_of_sight():
    ...
    assert game.rules.is_check
    assert game.rules.is_legal(rook_blocks_rook)
